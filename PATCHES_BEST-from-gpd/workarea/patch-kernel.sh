...
patch -p0 < PATCHES_BEST/prolific_PL-2501_usb2usb_network_adadapter/plusb.patch
...
patch -p1 < PATCHES_BEST/current_best_txpower/ATH_regd-NOctl_module-param.patch
